...
from show_and_tell.google_tools.google_auth import build_credentials

from werkzeug.utils import secure_filename

bp = flask.Blueprint('google_drive', __name__)
...
@bp.route('/gdrive/upload', methods=['GET', 'POST'])
def upload_file():
...
@bp.route('/gdrive/view/<file_id>', methods=['GET'])
